...
export const PHRASES: Phrase[] = [
  ...
  { key: "door.codeOnItsWay", en: "A code is on its way to {email}.", fr: "Un code part vers {email}.", where: "app", note: "Keep {email} exactly as it is." },
  ...
  { key: "door.noAccountThere", en: "There is no account with that address yet. Join us instead — it is one press below.", fr: "Aucun compte à cette adresse. Rejoignez-nous plutôt : c’est le bouton juste en dessous.", where: "app" },

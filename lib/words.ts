...
export const PHRASES: Phrase[] = [
  ...
  { key: "post.reply", en: "reply", fr: "répondre", where: "app", note: "The way into answering a post. Says the same thing whether or not it has been answered already — the replies are underneath where anybody can count them." },
